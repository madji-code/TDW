...
def view_products(request):
    ...
    return render(request, "sale_point/view-objects.html", {'all_objects': objects_list, 'logged_in': request.user.is_authenticated, 'back_page': 'sale_point:view-objects'})


def view_this_product(request, id):
    this_object = Product.objects.get(id=id)
    return render(request, "sale_point/view-this-object.html", {'this_object': this_object, 'logged_in': request.user.is_authenticated, 'back_page': 'sale_point:view-this-object'})